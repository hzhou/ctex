...
static void parsearguments(int argc, char **argv)
{
    ...
    for (int i=1; i<argc; i++) {
        if (strcmp(argv[i], "--help")==0) {
            ...
            printf("This is TANGLE, Version 4.5 - customized for CTeX\n");
            ...
            forceuppercase = false;
            forcelowercase = true;
        } else if ((strcmp(argv[i], "--underlines") == 0)) {
            allowunderlines = true;
        } else if ((strcmp(argv[i], "--strict") == 0)) {
            strictmode = true;
        } else if ((strcmp(argv[i], "--loose") == 0)) {
            strictmode = false;
            ...
            if (got_files==0) {
                webname = extendfilename(argv[i], "web");
                got_files++;
            } else if (got_files==1) {
                chgname = extendfilename(argv[i], "ch");
                got_files++;
            } else {
    ...
    if (!got_files) {
        fprintf(stderr, "Error: Need one or two file arguments.\n");
        usage_tangle();
    }
...
void openinput(void)
{
    webfile = mykpse_open_file(webname);
    if (chgname)
...
namepointer zidlookup(eightbits t)
{
  ...
  lab31:;
    if ((p == nameptr) || (t != 0)) {
        if (((p != nameptr) && (t != 0) && (ilk[p] == 0)) || ((p == nameptr) && (t == 0) && (buffer[idfirst] != 34))) {
            i = idfirst;
            s = 0;
            h = 0;
            while ((i < idloc) && (s < unambiglength)) {
                ...
                if ((buffer[i] != 95) || (allowunderlines && !strictmode)) {
                    ...
                    else if ((!strictmode && forcelowercase) && (buffer[i] >= 65) && (buffer[i] <= 90))
                        choppedid[s] = buffer[i] + 32;
                    else
                        ...
                        while ((k < bytestart[q + 3]) && (s < unambiglength)) {
                            ...
                            if (c != 95 || (allowunderlines && !strictmode)) {
                                if ((strictmode || forceuppercase) && (c >= 97))
                                    c = c - 32;
                                else if ((!strictmode && forcelowercase) && (c >= 65) && (c <= 90))
                                    c = c + 32;
                                if (choppedid[s] != c)
                                    goto lab32;
                                s = s + 1;
...
namepointer zmodlookup(sixteenbits l)
{
    ...
    while (p != 0) {

        {
            ...
            c = 1;
            j = 1;
            while ((k < bytestart[p + 3]) && (j <= l) && (modtext[j] == bytemem[w][k])) {
            ...
            case 4:
                {
                    while ((curstate.bytefield == curstate.endfield) && (stackptr > 0))
                        poplevel();
                    if ((stackptr == 0) || ((ilk[a] == 3) && (tokmem[zo][curstate.bytefield] != 40)) || ((ilk[a] == 4) && (tokmem[zo][curstate.bytefield] != 91))) {
                        {
                            putc('\n', stdout);
...
void zsendout(eightbits t, sixteenbits v)
{
  ...
  lab20:switch (outstate) {
        ...
        case 5:
            {
                if ((t == 3) || (((t == 2) && (v == 3) && (((outcontrib[1] == 68) && (outcontrib[2] == 73) && (outcontrib[3] == 86))
                                                           || ((outcontrib[1] == 100) && (outcontrib[2] == 105) && (outcontrib[3] == 118)) || ((outcontrib[1] == 77) && (outcontrib[2] == 79) &&
                                                                                                                                               (outcontrib[3] == 68)) || ((outcontrib[1] == 109) &&
                                                                                                                                                                          (outcontrib[2] == 111) &&
                                                                                                                                                                          (outcontrib[3] == 100)))) ||
                                 ((t == 0) && ((v == 42) || (v == 47)))
                    )) {
...
void zsendval(int v)
{
    /* 666 10 */ switch (outstate) {
        case 1:
            {
                if ((outptr == breakptr + 3) || ((outptr == breakptr + 4) && (outbuf[breakptr] == 32))) {

                    if (((outbuf[outptr - 3] == 68) && (outbuf[outptr - 2] == 73) && (outbuf[outptr - 1] == 86)) || ((outbuf[outptr - 3]
                                                                                                                      == 100) && (outbuf[outptr - 2] == 105) && (outbuf[outptr - 1] == 118)) ||
                        ((outbuf[outptr - 3] == 77) && (outbuf[outptr - 2] == 79) && (outbuf[outptr - 1] == 68)) || ((outbuf[outptr - 3] == 109) && (outbuf[outptr - 2] == 111) &&
                                                                                                                     (outbuf[outptr - 1] == 100)))
                        goto lab666;
                }
                outsign = 32;
        ...
        case 0:
            {
                if ((outptr == breakptr + 1) && ((outbuf[breakptr] == 42) || (outbuf[breakptr] == 47)))
                    goto lab666;
                outsign = 0;
                outstate = 3;
                outval = v;
...
void sendtheoutput(void)
{
    ...
    while (stackptr > 0) {
            ...
            case 13:
                {
                    ...
                    do {
                        ...
                        if (n >= 1073741824L) {
                            ...
                            n = 16 * n + curchar;
                        curchar = getoutput();
                    } while (!((curchar > 70) || (curchar < 48) || ((curchar > 57) && (curchar < 65))));
                    sendval(n);
                    goto lab21;
                }
                break;
      ...
      lab2:do {
            ...
            curchar = getoutput();
            if ((outcontrib[k] == 69) && ((curchar == 43) || (curchar == 45))) {
                if (k < linelength)
                    k = k + 1;
                outcontrib[k] = curchar;
                curchar = getoutput();
        ...
        case 122:
            {
                ...
                if (c != 0) {
                    ...
                    do {
                        loc = loc + 1;
                        d = buffer[loc];
                    } while (!(((d < 48) || ((d > 57) && (d < 65)) || ((d > 90) && (d < 97)) || (d > 122)) && (d != 95)));
                    if (loc > idfirst + 1) {
                        c = 130;
                        idloc = loc;
                    }
                ...
                if (c == 0)
                  ...
                  lab30:if (k >= longestname - 2) {
                    ...
                    if ((modtext[k] == 32) && (k > 0))
                        k = k - 1;
                    if (k > 3) {
                        if ((modtext[k] == 46) && (modtext[k - 1] == 46) && (modtext[k - 2] == 46))
            ...
            case 13:
                {
                    ...
                    do {
                        ...
                        nextcontrol = getnext();
                    } while (!((nextcontrol > 70) || (nextcontrol < 48) || ((nextcontrol > 57) && (nextcontrol < 65))));
                    {
                        accumulator = accumulator + nextsign * (val);
                        nextsign = 1;
                    }
...
{
    fprintf(stdout, "This is TANGLE, Version 4.5 - customized for CTeX\n");
