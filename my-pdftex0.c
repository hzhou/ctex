...
zprintcs ( int p ) 
{
  ...
  else if ( ( ( p >= 26627 ) && ( p <= 30185 ) ) || ( p > eqtbtop ) ) 
  printesc ( 584 ) ;
...
zprintfilename ( int n , int a , int e ) 
{
  ...
  while ( j++ < for_end ) ;} 
  if ( n != 0 ) 
  {register int for_end; j = strstart [n ];for_end = strstart [n + 1 
  ]- 1 ; if ( j <= for_end) do 
    if ( strpool [j ]!= 34 ) 
    print ( strpool [j ]) ;
  while ( j++ < for_end ) ;} 
  if ( e != 0 ) 
  {register int for_end; j = strstart [e ];for_end = strstart [e + 1 
  ]- 1 ; if ( j <= for_end) do 
    if ( strpool [j ]!= 34 ) 
    print ( strpool [j ]) ;
  while ( j++ < for_end ) ;} 
...
void 
zprintcsnames ( int hstart , int hfinish ) 
{
  printcsnames_regmem 
  int c, h  ;
  fprintf ( stderr , "%s%ld%s%ld%c\n",  "fmtdebug:csnames from " , (long)hstart , " to " , (long)hfinish ,   ':' ) ;
  {register int for_end; h = hstart ;for_end = hfinish ; if ( h <= 
  for_end) do 
    {
      if ( hash [h ].v.RH > 0 ) 
      {
	{register int for_end; c = strstart [hash [h ].v.RH ];
...
zhalf ( int x ) 
{
  register int Result; half_regmem 
  if ( odd ( x ) ) 
  Result = ( x + 1 ) / 2 ;
  else Result = x / 2 ;
  return Result ;
...
scaled 
zmultandadd ( int n , scaled x , scaled y , scaled maxanswer ) 
{
  ...
  if ( n == 0 ) 
  Result = y ;
  else if ( ( ( x <= ( maxanswer - y ) / n ) && ( - (int) x <= ( maxanswer 
  + y ) / n ) ) ) 
  Result = n * x + y ;
  else {
...
zxovern ( scaled x , int n ) 
{
  ...
  if ( n == 0 ) 
  {
    ...
    if ( x >= 0 ) 
    {
      ...
      Result = - (int) ( ( - (int) x ) / n ) ;
      texremainder = - (int) ( ( - (int) x ) % n ) ;
    } 
  } 
  if ( negative ) 
  texremainder = - (int) texremainder ;
  return Result ;
} 
scaled 
...
zmlog ( int x ) 
{
  register int Result; mlog_regmem 
  int y, z  ;
  int k  ;
  if ( x <= 0 ) 
  {
...
int 
zabvscd ( int a , int b , int c , int d ) 
{
  /* 10 */ register int Result; abvscd_regmem 
  int q, r  ;
  if ( a < 0 ) 
  {
    a = - (int) a ;
...
newrandoms ( void ) 
{
  ...
  unsigned char k  ;
  int x  ;
  {register int for_end; k = 0 ;for_end = 23 ; if ( k <= for_end) do 
    {
  ...
  while ( k++ < for_end ) ;} 
  {register int for_end; k = 24 ;for_end = 54 ; if ( k <= for_end) do 
    {
...
zinitrandoms ( int seed ) 
{
  ...
  k = 1 ;
  {register int for_end; i = 0 ;for_end = 54 ; if ( i <= for_end) do 
    {
      jj = k ;
      k = j - k ;
      j = jj ;
...
zunifrand ( int x ) 
{
  register int Result; unifrand_regmem 
  int y  ;
  if ( jrandom == 0 ) 
  newrandoms () ;
  else decr ( jrandom ) ;
...
normrand ( void ) 
{
  register int Result; normrand_regmem 
  int x, u, l  ;
  do {
      do { if ( jrandom == 0 ) 
      newrandoms () ;
...
#endif /* TEXMF_DEBUG */
void 
zshowtokenlist ( int p , int q , int l ) 
{
...
zcheckmem ( boolean printlocs ) 
{
  ...
  for_end) do 
    freearr [p ]= false ;
  while ( p++ < for_end ) ;} 
  {register int for_end; p = himemmin ;for_end = memend ; if ( p <= 
  for_end) do 
    freearr [p ]= false ;
  while ( p++ < for_end ) ;} 
  p = avail ;
  ...
  do {
    ...
    {register int for_end; q = p ;for_end = p + mem [p ].hh .v.LH - 1 
    ; if ( q <= for_end) do 
      {
	if ( freearr [q ]) 
	{
...
zsearchmem ( halfword p ) 
{
  searchmem_regmem 
  int q  ;
  {register int for_end; q = memmin ;for_end = lomemmax ; if ( q <= 
  for_end) do 
    {
      if ( mem [q ].hh .v.RH == p ) 
      {
  ...
  while ( q++ < for_end ) ;} 
  {register int for_end; q = himemmin ;for_end = memend ; if ( q <= 
  for_end) do 
    {
      if ( mem [q ].hh .v.RH == p ) 
      {
  ...
  while ( q++ < for_end ) ;} 
  {register int for_end; q = 1 ;for_end = 27688 ; if ( q <= for_end) do 
    {
      if ( eqtb [q ].hh .v.RH == p ) 
      {
	printnl ( 577 ) ;
  ...
  while ( q++ < for_end ) ;} 
  if ( saveptr > 0 ) 
  {register int for_end; q = 0 ;for_end = saveptr - 1 ; if ( q <= 
  for_end) do 
    {
  ...
  while ( q++ < for_end ) ;} 
  {register int for_end; q = 0 ;for_end = hyphsize ; if ( q <= for_end) 
  do 
    {
      if ( hyphlist [q ]== p ) 
      {
...
void 
zpdfprintchar ( internalfontnumber f , int c ) 
{
  pdfprintchar_regmem 
  pdfmarkchar ( f , c ) ;
...
scaled 
zdividescaled ( scaled s , scaled m , int dd ) 
{
  ...
  q = s / m ;
  r = s % m ;
  {register int for_end; i = 1 ;for_end = dd ; if ( i <= for_end) do 
    {
      q = 10 * q + ( 10 * r ) / m ;
      r = ( 10 * r ) % m ;
    } 
...
void 
zappenddestname ( strnumber s , int n ) 
{
...
zpdfcreateobj ( int t , int i ) 
{
  ...
  else if ( t != 0 ) 
  {
    ...
    headtab [t ]= objptr ;
    if ( ( t == 5 ) && ( i < 0 ) ) 
    appenddestname ( - (int) objtab [objptr ].int0 , objptr ) ;
  } 
} 
int 
pdfnewobjnum ( void ) 
{
  register int Result; pdfnewobjnum_regmem 
  pdfcreateobj ( 0 , 0 ) ;
  Result = objptr ;
  return Result ;
} 
...
void 
zpdfosprepareobj ( int i , int pdfoslevel ) 
{
...
void 
zpdfbeginobj ( int i , int pdfoslevel ) 
{
  pdfbeginobj_regmem 
  checkpdfversion () ;
...
void 
zpdfnewobj ( int t , int i , int pdfos ) 
{
  pdfnewobj_regmem 
  pdfcreateobj ( t , i ) ;
...
void 
zpdfbegindict ( int i , int pdfoslevel ) 
{
  pdfbegindict_regmem 
  checkpdfversion () ;
  pdfosprepareobj ( i , pdfoslevel ) ;
...
void 
zpdfnewdict ( int t , int i , int pdfos ) 
{
  pdfnewdict_regmem 
  pdfcreateobj ( t , i ) ;
...
halfword 
zpdflookuplist ( halfword p , int i ) 
{
...
{
  register int Result; getmicrointerval_regmem 
  int s, m  ;
...
void 
zprintglue ( scaled d , int order , strnumber s ) 
{
  printglue_regmem 
  printscaled ( d ) ;
  if ( ( order < 0 ) || ( order > 3 ) ) 
...
showactivities ( void ) 
{
  ...
  printnl ( 345 ) ;
  println () ;
  {register int for_end; p = nestptr ;for_end = 0 ; if ( p >= for_end) 
  do 
    {
      m = nest [p ].modefield ;
      a = nest [p ].auxfield ;
	...
	if ( memtop - 2 != pagetail ) 
	{
	  ...
	  if ( pagecontents > 0 ) 
	  {
	    ...
	    while ( r != memtop ) {
	      ...
	      printint ( t ) ;
	      print ( 1403 ) ;
	      if ( eqtb [29384 + t ].cint == 1000 ) 
	      t = mem [r + 3 ].cint ;
	      else t = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29384 + 
	      t ].cint ;
	      printscaled ( t ) ;
	      if ( mem [r ].hh.b0 == 1 ) 
	      {
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 73 : 
    ...
    printparam ( chrcode - 29277 ) ;
      ...
      printesc ( 539 ) ;
      printint ( chrcode - 29384 ) ;
    } 
    break ;
  case 74 : 
    if ( chrcode < 29930 ) 
    printlengthparam ( chrcode - 29896 ) ;
    else {
	
      printesc ( 576 ) ;
      printint ( chrcode - 29930 ) ;
    } 
    break ;
  case 45 : 
    printesc ( 586 ) ;
...
zshoweqtb ( halfword n ) 
{
  ...
  if ( n < 1 ) 
  printchar ( 63 ) ;
  else if ( ( n < 26628 ) || ( ( n > 30185 ) && ( n <= eqtbtop ) ) ) 
  {
    sprintcs ( n ) ;
    printchar ( 61 ) ;
...
zidlookup ( int j , int l ) 
{
  ...
  halfword k  ;
  h = buffer [j ];
  {register int for_end; k = j + 1 ;for_end = j + l - 1 ; if ( k <= 
  for_end) do 
    {
      h = h + h + buffer [k ];
  ...
  while ( true ) {
	...
	{register int for_end; k = j ;for_end = j + l - 1 ; if ( k <= 
	for_end) do 
	  {
...
pseudoinput ( void ) 
{
  ...
  Result = false ;
    ...
    last = first ;
    {register int for_end; r = p + 1 ;for_end = p + sz - 1 ; if ( r <= 
    for_end) do 
      {
	w = mem [r ].qqqq ;
	buffer [last ]= w .b0 ;
...
void 
zeqworddefine ( halfword p , int w ) 
{
...
void 
zgeqworddefine ( halfword p , int w ) 
{
...
showcontext ( void ) 
{
  ...
  while ( true ) {
	...
	{register int for_end; q = p ;for_end = firstcount - 1 ; if ( q 
	<= for_end) do 
	  printchar ( trickbuf [q % errorline ]) ;
	while ( q++ < for_end ) ;} 
	println () ;
	{register int for_end; q = 1 ;for_end = n ; if ( q <= for_end) 
	do 
	  printchar ( 32 ) ;
	while ( q++ < for_end ) ;} 
	if ( m + n <= errorline ) 
	...
	{register int for_end; q = firstcount ;for_end = p - 1 ; if ( q 
	<= for_end) do 
	  printchar ( trickbuf [q % errorline ]) ;
	while ( q++ < for_end ) ;} 
	if ( m + n > errorline ) 
...
firmuptheline ( void ) 
{
  ...
  if ( eqtb [29305 ].cint > 0 ) {
	...
	terminput () ;
      ...
      if ( last > first ) 
      {
	{register int for_end; k = first ;for_end = last - 1 ; if ( k <= 
	for_end) do 
...
macrocall ( void ) 
{
  ...
  if ( mem [r ].hh .v.LH != 3584 ) 
  {
	...
	if ( longstate != 114 ) 
	{
	  ...
	  {register int for_end; m = 0 ;for_end = n ; if ( m <= for_end) 
	  do 
	    flushlist ( pstack [m ]) ;
	  while ( m++ < for_end ) ;} 
	  goto lab10 ;
	...
	;
		...
		pstack [n ]= mem [memtop - 3 ].hh .v.RH ;
		alignstate = alignstate - unbalance ;
		{register int for_end; m = 0 ;for_end = n ; if ( m <= 
		for_end) do 
		  flushlist ( pstack [m ]) ;
		while ( m++ < for_end ) ;} 
		goto lab10 ;
  ...
  if ( n > 0 ) 
  {
    ...
    {register int for_end; m = 0 ;for_end = n - 1 ; if ( m <= for_end) 
    do 
...
znewindex ( quarterword i , halfword q ) 
{
  ...
  {register int for_end; k = 1 ;for_end = 8 ; if ( k <= for_end) do 
    mem [curptr + k ]= sanull ;
  while ( k++ < for_end ) ;} 
} 
void 
...
{
  /* 10 */ register int Result; testnoligatures_regmem 
  int c  ;
  Result = 1 ;
  {register int for_end; c = fontbc [f ];for_end = fontec [f ]; if ( 
  c <= for_end) do 
    if ( ( fontinfo [charbase [f ]+ c ].qqqq .b0 > 0 ) ) {
...
{
  register int Result; gettagcode_regmem 
  smallnumber i  ;
...
zscansomethinginternal ( smallnumber level , boolean negative ) 
{
  ...
  case 89 : 
	...
	{case 0 : 
	  curval = eqtb [29384 + curval ].cint ;
	  break ;
	case 1 : 
	  curval = eqtb [29930 + curval ].cint ;
	  break ;
	case 2 : 
  ...
  case 70 : 
	...
	if ( negative ) {
	  ...
	  if ( curvallevel >= 2 ) 
	  {
	    ...
	    deleteglueref ( m ) ;
	    {
	      mem [curval + 1 ].cint = - (int) mem [curval + 1 ].cint 
	      ;
	      mem [curval + 2 ].cint = - (int) mem [curval + 2 ].cint 
	      ;
	      mem [curval + 3 ].cint = - (int) mem [curval + 3 ].cint 
	      ;
	    } 
	  } 
...
zscandimen ( boolean mu , boolean inf , boolean shortcut ) 
{
  ...
  if ( ! shortcut ) 
  {
	...
	lab31: {
	    register int for_end; kk = k ;for_end = 1 ; if ( kk >= 
	for_end) do 
	  {
  ...
  case 19 : 
    {
      ...
      warningindex = savewarningindex ;
      scannerstatus = savescannerstatus ;
      curval = newcolorstack ( s , curval , flag ) ;
      flushstr ( s ) ;
      curvallevel = 0 ;
      if ( curval < 0 ) 
      {
...
void 
zreadtoks ( int n , halfword r , halfword j ) 
{
  /* 30 */ readtoks_regmem 
  halfword p  ;
  halfword q  ;
...
endname ( void ) 
{
  ...
  if ( areadelimiter != 0 ) 
  {
    ...
    if ( mustquote ) 
    {
      {register int for_end; j = poolptr - 1 ;for_end = t ; if ( j >= 
      for_end) do 
	strpool [j + 2 ]= strpool [j ];
      while ( j-- > for_end ) ;} 
      strpool [t + 1 ]= 34 ;
      {register int for_end; j = t - 1 ;for_end = s ; if ( j >= for_end) 
      do 
  ...
  curarea = 345 ;
    ...
    if ( tempstr > 0 ) 
    {
      curarea = tempstr ;
      decr ( strptr ) ;
      {register int for_end; j = strstart [strptr + 1 ];for_end = 
...
void 
zpackbufferedname ( smallnumber n , int a , int b ) 
{
  ...
  while ( j++ < for_end ) ;} 
  {register int for_end; j = a ;for_end = b ; if ( j <= for_end) do 
    {
      c = buffer [j ];
      if ( ! ( c == 34 ) ) 
      {
  ...
  while ( j++ < for_end ) ;} 
  {register int for_end; j = formatdefaultlength - 3 ;for_end = 
...
makenamestring ( void ) 
{
  ...
  Result = 63 ;
    ...
    {register int for_end; k = 1 ;for_end = namelength ; if ( k <= 
    for_end) do 
      {
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    {register int for_end; k = 3 * eqtb [29299 ].cint - 2 ;for_end = 3 
  ...
  decr ( l ) ;
  {register int for_end; k = 1 ;for_end = l ; if ( k <= for_end) do 
    print ( buffer [k ]) ;
  while ( k++ < for_end ) ;} 
  println () ;
...
zreadfontinfo ( halfword u , strnumber nom , strnumber aire , scaled s ) 
{
  ...
  {register int for_end; k = fmemptr ;for_end = widthbase [f ]- 1 
  ; if ( k <= for_end) do 
    {
      {
	tfmtemp = getc ( tfmfile ) ;
  ...
  while ( k++ < for_end ) ;} 
  {
    ...
    {register int for_end; k = widthbase [f ];for_end = ligkernbase [
    f ]- 1 ; if ( k <= for_end) do 
      {
	tfmtemp = getc ( tfmfile ) ;
	a = tfmtemp ;
  ...
  if ( nl > 0 ) 
  {
    {register int for_end; k = ligkernbase [f ];for_end = kernbase [f 
  ...
  {register int for_end; k = kernbase [f ]+ 256 * ( 128 ) ;for_end = 
  ...
  while ( k++ < for_end ) ;} 
  {register int for_end; k = extenbase [f ];for_end = parambase [f ]
  - 1 ; if ( k <= for_end) do 
    {
      {
	tfmtemp = getc ( tfmfile ) ;
  ...
  while ( k++ < for_end ) ;} 
  {
    {register int for_end; k = 1 ;for_end = np ; if ( k <= for_end) do 
      if ( k == 1 ) 
      {
	tfmtemp = getc ( tfmfile ) ;
	sw = tfmtemp ;
    ...
    if ( feof ( tfmfile ) ) 
    goto lab11 ;
    {register int for_end; k = np + 1 ;for_end = 7 ; if ( k <= for_end) 
    do 
...
zdvifontdef ( internalfontnumber f ) 
{
  ...
  {register int for_end; k = strstart [fontarea [f ]];for_end = 
  ...
  while ( k++ < for_end ) ;} 
  {register int for_end; k = strstart [fontname [f ]];for_end = 
...
zspecialout ( halfword p ) 
{
  ...
  {register int for_end; k = strstart [strptr ];for_end = poolptr - 1 
  ; if ( k <= for_end) do 
...
zwriteout ( halfword p ) 
{
  ...
  if ( j == 18 ) 
  {
    ...
    selector = 17 ;
    printnl ( 1917 ) ;
    {register int for_end; d = 0 ;for_end = ( poolptr - strstart [
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 1928 , 946 ) ;
	  writeopen [j ]= true ;
  ...
  case 21 : 
    ...
    default: 
    {
      if ( ( 6 <= mem [p ].hh.b1 ) && ( mem [p ].hh.b1 <= 47 ) ) 
      pdferror ( 1861 , 1927 ) ;
      else confusion ( 1861 ) ;
    } 
    break ;
...
halfword 
zzreverse ( halfword thisbox , halfword t , scaled * curg , double * curglue ) 
{
...
hlistout ( void ) 
{
  ...
  while ( p != -268435455L ) lab21: if ( ( p >= himemmin ) ) 
  {
	...
	dvih = curh ;
	curh = curh + ( - (int) accentwidth - delta ) ;
	if ( curh != dvih ) 
	{
	  movement ( curh - dvih , 143 ) ;
	  dvih = curh ;
...
zdvishipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [29294 ].cint ) ;
  {
    ...
    printchar ( 91 ) ;
    j = 9 ;
    while ( ( eqtb [29384 + j ].cint == 0 ) && ( j > 0 ) ) decr ( j ) ;
    {register int for_end; k = 0 ;for_end = j ; if ( k <= for_end) do 
      {
	printint ( eqtb [29384 + k ].cint ) ;
	if ( k < j ) 
	printchar ( 46 ) ;
      } 
    while ( k++ < for_end ) ;} 
    ...
    29915 ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29914 ]
    .cint > 1073741823L ) ) 
    {
      {
	if ( interaction == 3 ) 
    ...
    if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29915 ].cint > 
    maxv ) 
    maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29915 ].cint ;
    if ( mem [p + 1 ].cint + eqtb [29914 ].cint > maxh ) 
    maxh = mem [p + 1 ].cint + eqtb [29914 ].cint ;
    dvih = 0 ;
    dviv = 0 ;
    curh = eqtb [29914 ].cint ;
    dvif = 0 ;
    curhoffset = eqtb [29914 ].cint ;
    curvoffset = eqtb [29915 ].cint ;
    if ( eqtb [29919 ].cint != 0 ) 
    curpagewidth = eqtb [29919 ].cint ;
    else curpagewidth = mem [p + 1 ].cint + 2 * curhoffset + 2 * 4736286L ;
    if ( eqtb [29920 ].cint != 0 ) 
    curpageheight = eqtb [29920 ].cint ;
	...
	{register int for_end; s = 0 ;for_end = l - 1 ; if ( s <= 
	for_end) do 
	  {
	...
	{register int for_end; s = strstart [strptr ];for_end = 
    ...
    {register int for_end; k = 0 ;for_end = 9 ; if ( k <= for_end) do 
      dvifour ( eqtb [29384 + k ].cint ) ;
    while ( k++ < for_end ) ;} 
    dvifour ( lastbop ) ;
    lastbop = pageloc ;
    curv = mem [p + 3 ].cint + eqtb [29915 ].cint ;
    tempptr = p ;
    if ( mem [p ].hh.b0 == 1 ) 
    vlistout () ;
    else hlistout () ;
...
{
  register int Result; getpdfcompresslevel_regmem 
...
{
  register int Result; getpdfsuppresswarningdupmap_regmem 
...
{
  register int Result; getpdfsuppresswarningpagegroup_regmem 
...
{
  register int Result; getpdfsuppressptexinfo_regmem 
...
{
  register int Result; getpdfomitcharset_regmem 
...
zgettexint ( int code ) 
{
  register int Result; gettexint_regmem 
  Result = eqtb [29277 + code ].cint ;
  return Result ;
} 
scaled 
zgettexdimen ( int code ) 
{
  register scaled Result; gettexdimen_regmem 
  Result = eqtb [29896 + code ].cint ;
  return Result ;
} 
scaled 
...
zpdfgetmem ( int s ) 
{
  register int Result; pdfgetmem_regmem 
  int a  ;
...
int 
zfixint ( int val , int min , int max ) 
{
  register int Result; fixint_regmem 
  if ( val < min ) 
  Result = min ;
  else if ( val > max ) 
  Result = max ;
...
void 
zpdfusefont ( internalfontnumber f , int fontnum ) 
{
  pdfusefont_regmem 
  {
...
zpdfsetfont ( internalfontnumber f ) 
{
  ...
  while ( p != -268435455L ) {
      
    {
      ...
      ff = - (int) pdffontnum [mem [p ].hh .v.LH ];
...
void 
zslowprintsubstr ( int s , int maxlen ) 
{
...
void 
zpdfintentry ( strnumber s , int v ) 
{
  pdfintentry_regmem 
  {
    {
...
void 
zpdfintentryln ( strnumber s , int v ) 
{
...
void 
zpdfindirect ( strnumber s , int o ) 
{
  pdfindirect_regmem 
  {
    {
...
void 
zpdfindirectln ( strnumber s , int o ) 
{
...
void 
zsettagcode ( internalfontnumber f , eightbits c , int i ) 
{
  settagcode_regmem 
  int fixedi  ;
  if ( ( ( fontbc [f ]<= c ) && ( c <= fontec [f ]) && ( fontinfo [
...
zinitfontbase ( int v ) 
{
  register int Result; initfontbase_regmem 
  int i, j  ;
  i = pdfgetmem ( 256 ) ;
  {register int for_end; j = 0 ;for_end = 255 ; if ( j <= for_end) do 
    pdfmem [i + j ]= v ;
  while ( j++ < for_end ) ;} 
  Result = i ;
  return Result ;
...
void 
zsetlpcode ( internalfontnumber f , eightbits c , int i ) 
{
  setlpcode_regmem 
...
void 
zsetrpcode ( internalfontnumber f , eightbits c , int i ) 
{
  setrpcode_regmem 
...
void 
zsetefcode ( internalfontnumber f , eightbits c , int i ) 
{
  setefcode_regmem 
...
void 
zsetknbscode ( internalfontnumber f , eightbits c , int i ) 
{
  setknbscode_regmem 
...
void 
zsetstbscode ( internalfontnumber f , eightbits c , int i ) 
{
  setstbscode_regmem 
...
void 
zsetshbscode ( internalfontnumber f , eightbits c , int i ) 
{
  setshbscode_regmem 
...
void 
zsetknbccode ( internalfontnumber f , eightbits c , int i ) 
{
  setknbccode_regmem 
...
void 
zsetknaccode ( internalfontnumber f , eightbits c , int i ) 
{
  setknaccode_regmem 
...
strnumber 
zexpandfontname ( internalfontnumber f , int e ) 
{
...
internalfontnumber 
zautoexpandfont ( internalfontnumber f , int e ) 
{
...
void 
zcopyexpandparams ( internalfontnumber k , internalfontnumber f , int e ) 
{
...
ztfmlookup ( strnumber s , scaled fs ) 
{
  ...
  if ( fs != 0 ) 
  {
    {register int for_end; k = 1 ;for_end = fontptr ; if ( k <= for_end) 
    do 
...
internalfontnumber 
zloadexpandfont ( internalfontnumber f , int e ) 
{
...
int 
zfixexpandvalue ( internalfontnumber f , int e ) 
{
  ...
  if ( e < 0 ) 
  {
    e = - (int) e ;
    neg = true ;
    maxexpand = - (int) pdffontexpandratio [pdffontshrink [f ]];
  } 
  else {
...
internalfontnumber 
zgetexpandfont ( internalfontnumber f , int e ) 
{
...
internalfontnumber 
zexpandfont ( internalfontnumber f , int e ) 
{
...
stretchlimit , int shrinklimit , int fontstep , int expandratio ) 
{
  ...
  if ( shrinklimit > 0 ) 
  pdffontshrink [f ]= getexpandfont ( f , - (int) shrinklimit ) ;
  if ( expandratio != 0 ) 
...
zvfexpandlocalfonts ( internalfontnumber f ) 
{
  ...
  {register int for_end; k = 0 ;for_end = vflocalfontnum [f ]- 1 
  ; if ( k <= for_end) do 
    {
      lf = vfifnts [vfdefaultfont [f ]+ k ];
      setexpandparams ( lf , pdffontautoexpand [f ], pdffontexpandratio [
      pdffontstretch [f ]], - (int) pdffontexpandratio [pdffontshrink 
...
readexpandfont ( void ) 
{
  ...
  if ( ( pdffontstep [f ]!= 0 ) ) 
  {
    ...
    pdffontshrink [f ]!= 0 ) && ( - (int) pdffontexpandratio [
...
internalfontnumber 
zletterspacefont ( halfword u , internalfontnumber f , int e ) 
{
  ...
  {register int for_end; c = fontbc [k ];for_end = fontec [k ]; if ( 
  c <= for_end) do 
    {
      {
...
zcopyfontinfo ( internalfontnumber f ) 
{
  ...
  overflow ( 1088 , fontmemsize ) ;
  {register int for_end; i = 0 ;for_end = lf - 1 ; if ( i <= for_end) do 
...
zvfreadsigned ( int k ) 
{
  register int Result; vfreadsigned_regmem 
  int i  ;
  pdfassert ( ( k > 0 ) && ( k <= 4 ) ) ;
  i = vfbyte () ;
  if ( i >= 128 ) 
...
int 
zvfreadunsigned ( int k ) 
{
  register int Result; vfreadunsigned_regmem 
  int i  ;
  pdfassert ( ( k > 0 ) && ( k <= 4 ) ) ;
  i = vfbyte () ;
  if ( ( k == 4 ) && ( i >= 128 ) ) 
...
zdovf ( internalfontnumber f ) 
{
  ...
  cmdlength = vfbyte () ;
  {register int for_end; k = 1 ;for_end = cmdlength ; if ( k <= for_end) 
  do 
    {
      if ( vfbyte () != 0 ) 
      ;
...
zautoexpandvf ( internalfontnumber f ) 
{
  ...
  {register int for_end; k = 0 ;for_end = vflocalfontnum [bf ]- 1 
  ; if ( k <= for_end) do 
    {
...
int 
zpacketreadsigned ( int k ) 
{
  register int Result; packetreadsigned_regmem 
  int i  ;
  pdfassert ( ( k > 0 ) && ( k <= 4 ) ) ;
  i = packetbyte () ;
  if ( i >= 128 ) 
...
int 
zpacketreadunsigned ( int k ) 
{
  register int Result; packetreadunsigned_regmem 
  int i  ;
  pdfassert ( ( k > 0 ) && ( k <= 4 ) ) ;
  i = packetbyte () ;
  if ( ( k == 4 ) && ( i >= 128 ) ) 
...
void 
zwarndestdup ( int id , smallnumber byname , strnumber s1 , strnumber s2 ) 
{
  warndestdup_regmem 
  if ( eqtb [29367 ].cint > 0 ) 
  return ;
  pdfwarning ( s1 , 1848 , false , false ) ;
  if ( byname > 0 ) 
  {
    print ( 1834 ) ;
    printmark ( id ) ;
...
endlink ( void ) 
{
  ...
  -1073741824L ) ) 
  {
    ...
    if ( isshippingpage && matrixused () ) 
    {
      matrixrecalculate ( curh + eqtb [29921 ].cint ) ;
      mem [p + 1 ].cint = getllx () - eqtb [29921 ].cint ;
      mem [p + 2 ].cint = curpageheight - getury () - eqtb [29921 ].cint ;
      mem [p + 3 ].cint = geturx () + eqtb [29921 ].cint ;
      mem [p + 4 ].cint = curpageheight - getlly () + eqtb [29921 ].cint ;
    } 
    else mem [p + 3 ].cint = curh + eqtb [29921 ].cint ;
  } 
  poplinklevel () ;
} 
void 
...
zdothread ( halfword p , halfword parentbox , scaled x , scaled y ) 
{
  ...
  setrectdimens ( p , parentbox , x , y , mem [p + 1 ].cint , mem [p + 2 ]
  .cint , mem [p + 3 ].cint , eqtb [29923 ].cint ) ;
  appendbead ( p ) ;
  lastthread = p ;
} 
void 
...
endthread ( void ) 
{
  ...
  mem [lastthread + 4 ].cint = curv + eqtb [29923 ].cint ;
  if ( pdflastthreadnamedid ) 
...
{
  register int Result; opensubentries_regmem 
  int k, c  ;
  int l, r  ;
  k = 0 ;
...
zdodest ( halfword p , halfword parentbox , scaled x , scaled y ) 
{
  ...
  {
    warndestdup ( mem [p + 5 ].hh .v.RH , mem [p + 5 ].hh.b1 , 1861 , 1862 
    ) ;
    return ;
  } 
  objtab [k ].int4 = p ;
...
pdfhlistout ( void ) 
{
  ...
  leftedge = curh ;
  {register int for_end; i = 1 ;for_end = pdflinkstackptr ; if ( i <= 
  for_end) do 
    {
...
zpdfshipout ( halfword p , boolean shippingpage ) 
{
  ...
  int saveimageprocset  ;
  int savetextprocset  ;
  int pdflastresources  ;
  if ( eqtb [29311 ].cint > 0 ) 
  {
    printnl ( 345 ) ;
    println () ;
  ...
  pdfoutputvalue = eqtb [29339 ].cint ;
  if ( shippingpage ) 
  synctexsheet ( eqtb [29294 ].cint ) ;
  else synctexpdfxform ( p ) ;
  if ( ( mem [p + 3 ].cint > 1073741823L ) || ( mem [p + 2 ].cint > 
  1073741823L ) || ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29915 
  ].cint > 1073741823L ) || ( mem [p + 1 ].cint + eqtb [29914 ].cint > 
  1073741823L ) ) 
  {
    {
      if ( interaction == 3 ) 
  ...
  if ( mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29915 ].cint > maxv 
  ) 
  maxv = mem [p + 3 ].cint + mem [p + 2 ].cint + eqtb [29915 ].cint ;
  if ( mem [p + 1 ].cint + eqtb [29914 ].cint > maxh ) 
  maxh = mem [p + 1 ].cint + eqtb [29914 ].cint ;
  ...
  if ( ! shippingpage ) 
  {
    ...
    curhoffset = eqtb [29917 ].cint + eqtb [29914 ].cint ;
    curvoffset = eqtb [29918 ].cint + eqtb [29915 ].cint ;
    if ( eqtb [29919 ].cint != 0 ) 
    curpagewidth = eqtb [29919 ].cint ;
  ...
  if ( pdffontlist != -268435455L ) 
  {
	...
	ff = - (int) pdffontnum [mem [k ].hh .v.LH ];
...
zpdffixdest ( int k ) 
{
  ...
  if ( objtab [k ].int4 != -268435455L ) 
  return ;
  pdfwarning ( 1199 , 345 , false , false ) ;
  if ( objtab [k ].int0 < 0 ) 
  {
    print ( 1200 ) ;
    print ( - (int) objtab [k ].int0 ) ;
    print ( 125 ) ;
  } 
  else {
...
pdfprintinfo ( void ) 
{
  ...
  if ( pdfinfotoks != -268435455L ) 
  {
    ...
    creatorgiven = substrofstr ( 1221 , s ) ;
    producergiven = substrofstr ( 1222 , s ) ;
    creationdategiven = substrofstr ( 1223 , s ) ;
    moddategiven = substrofstr ( 1224 , s ) ;
    trappedgiven = substrofstr ( 1225 , s ) ;
  } 
  if ( ! producergiven ) 
  {
    pdfprint ( 1230 ) ;
  ...
  {
    pdfstrentryln ( 1229 , pdftexbanner ) ;
  } 
  pdfenddict () ;
} 
void 
...
zcheckexpandpars ( internalfontnumber f ) 
{
  ...
  {
    if ( maxshrinkratio < 0 ) 
    maxshrinkratio = - (int) pdffontexpandratio [k ];
    else if ( maxshrinkratio != - (int) pdffontexpandratio [k ]) 
    pdferror ( 1041 , 1251 ) ;
  } 
  Result = true ;
  return Result ;
...
void 
zdosubstfont ( halfword p , int exratio ) 
{
  dosubstfont_regmem 
  internalfontnumber f, k  ;
  halfword r  ;
  ...
  k = expandfont ( f , extxnoverd ( exratio * ef , - (int) 
...
zhpack ( halfword p , scaled w , smallnumber m ) 
{
  ...
  while ( p != -268435455L ) {
      ...
      case 40 : 
	{
	  ...
	  else if ( m == 3 ) 
	  {
	    ...
	    mem [p + 1 ].cint = - (int) charpw ( mem [p + 2 ].hh .v.LH 
	    , mem [p ].hh.b1 ) ;
	  } 
	  x = x + mem [p + 1 ].cint ;
	} 
  ...
  else if ( x > 0 ) 
  {
    ...
    mem [r + 5 ].hh.b0 = 2 ;
    if ( totalshrink [o ]!= 0 ) 
    mem [r + 6 ].gr = ( - (int) x ) / ((double) totalshrink [o ]) ;
    else {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      ...
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (int) x - totalshrink [0 ]> eqtb [29904 ].cint ) || ( 
      eqtb [29303 ].cint < 100 ) ) 
      {
	if ( ( eqtb [29912 ].cint > 0 ) && ( - (int) x - totalshrink [0 
	]> eqtb [29904 ].cint ) ) 
	{
	  while ( mem [q ].hh .v.RH != -268435455L ) q = mem [q ].hh .v.RH 
	  ;
	  mem [q ].hh .v.RH = newrule () ;
	  mem [mem [q ].hh .v.RH + 1 ].cint = eqtb [29912 ].cint ;
	} 
	println () ;
	printnl ( 1264 ) ;
...
zvpackage ( halfword p , scaled h , smallnumber m , scaled l ) 
{
  ...
  else if ( x > 0 ) 
  {
    ...
    ].hh .v.RH != -268435455L ) ) 
    {
      lastbadness = 1000000L ;
      mem [r + 6 ].gr = 1.0 ;
      if ( ( - (int) x - totalshrink [0 ]> eqtb [29905 ].cint ) || ( 
      eqtb [29304 ].cint < 100 ) ) 
      {
	println () ;
	printnl ( 1269 ) ;
...
zappendtovlist ( halfword b ) 
{
  ...
  scaled d  ;
  halfword p  ;
  if ( curlist .auxfield .cint > eqtb [29928 ].cint ) 
  {
    d = mem [eqtb [26629 ].hh .v.RH + 1 ].cint - curlist .auxfield .cint - 
    mem [b + 3 ].cint ;
    if ( d < eqtb [29898 ].cint ) 
    p = newparamglue ( 0 ) ;
    else {
...
zvardelimiter ( halfword d , smallnumber s , scaled v ) 
{
  ...
  lab40: if ( f != 0 ) {
	...
	w = w + u ;
      ...
      stackintobox ( b , f , c ) ;
      c = r .b3 ;
      {register int for_end; m = 1 ;for_end = n ; if ( m <= for_end) do 
	stackintobox ( b , f , c ) ;
      while ( m++ < for_end ) ;} 
      c = r .b1 ;
      if ( c != 0 ) 
	...
	stackintobox ( b , f , c ) ;
	c = r .b3 ;
	{register int for_end; m = 1 ;for_end = n ; if ( m <= for_end) 
	do 
	  stackintobox ( b , f , c ) ;
	while ( m++ < for_end ) ;} 
      } 
...
zmakeradical ( halfword q ) 
{
  ...
  if ( delta > 0 ) 
  clr = clr + half ( delta ) ;
  mem [y + 4 ].cint = - (int) ( mem [x + 3 ].cint + clr ) ;
...
zmakescripts ( halfword q , scaled delta ) 
{
  ...
  if ( mem [q + 2 ].hh .v.RH == 0 ) 
  {
    ...
    mem [x + 1 ].cint = mem [x + 1 ].cint + eqtb [29908 ].cint ;
    ...
    if ( mem [q + 3 ].hh .v.RH == 0 ) 
    mem [x + 4 ].cint = - (int) shiftup ;
    else {
	
      y = cleanbox ( q + 3 , 2 * ( curstyle / 4 ) + 5 ) ;
      mem [y + 1 ].cint = mem [y + 1 ].cint + eqtb [29908 ].cint ;
...
zmakeleftright ( halfword q , smallnumber style , scaled maxd , scaled maxh ) 
{
  ...
  delta2 = delta1 + delta1 - eqtb [29906 ].cint ;
  if ( delta < delta2 ) 
  delta = delta2 ;
...
void 
ztrybreak ( int pi , smallnumber breaktype ) 
{
  ...
  while ( true ) {
	...
	r == memtop - 7 ) ) ) 
	{
	  ...
	  {register int for_end; fitclass = 0 ;for_end = 3 ; if ( 
	  fitclass <= for_end) do 
	    {
	...
	marginkernshrink ) > 0 ) ) 
	{
	  if ( ( curactivewidth [8 ]+ marginkernshrink ) > - (int) 
	  shortfall ) 
	  shortfall = - (int) ( ( curactivewidth [8 ]+ marginkernshrink 
	...
	( curactivewidth [5 ]!= 0 ) ) 
	{
	  if ( dolastlinefit ) 
	  {
		...
		goto lab40 ;
	      ...
	      {
		if ( - (int) g > curactivewidth [6 ]) 
		g = - (int) curactivewidth [6 ];
		b = badness ( - (int) g , curactivewidth [6 ]) ;
		if ( b > 12 ) 
		fitclass = 3 ;
		else fitclass = 2 ;
		goto lab40 ;
...
zpostlinebreak ( boolean d ) 
{
  ...
  do {
	...
	p = findprotcharright ( mem [memtop - 3 ].hh .v.RH , p ) ;
      ...
      if ( w != 0 ) 
      {
	k = newmarginkern ( - (int) w , lastrightmostchar , 1 ) ;
    ...
    if ( eqtb [29358 ].cint > 0 ) 
    {
      ...
      if ( w != 0 ) 
      {
	k = newmarginkern ( - (int) w , lastleftmostchar , 0 ) ;
	mem [k ].hh .v.RH = q ;
	q = k ;
      } 
    } 
    ...
    if ( eqtb [29926 ].cint != eqtb [29928 ].cint ) 
    mem [justbox + 3 ].cint = eqtb [29926 ].cint ;
    if ( eqtb [29927 ].cint != eqtb [29928 ].cint ) 
    mem [justbox + 2 ].cint = eqtb [29927 ].cint ;
    if ( ( eqtb [29924 ].cint != eqtb [29928 ].cint ) && ( curline == 
    curlist .pgfield + 1 ) ) 
    mem [justbox + 3 ].cint = eqtb [29924 ].cint ;
    if ( ( eqtb [29925 ].cint != eqtb [29928 ].cint ) && ( curline + 1 == 
    bestline ) ) 
...
hyphenate ( void ) 
{
  ...
  strnumber k  ;
  poolpointer u  ;
  {register int for_end; j = 0 ;for_end = hn ; if ( j <= for_end) do 
    hyf [j ]= 0 ;
  while ( j++ < for_end ) ;} 
  h = hc [1 ];
  incr ( hn ) ;
  hc [hn ]= curlang ;
  {register int for_end; j = 2 ;for_end = hn ; if ( j <= for_end) do 
    h = ( h + h + hc [j ]) % 607 ;
  while ( j++ < for_end ) ;} 
  while ( true ) {
  ...
  hc [hn + 1 ]= 0 ;
  hc [hn + 2 ]= 256 ;
  {register int for_end; j = 0 ;for_end = hn - rhyf + 1 ; if ( j <= 
  for_end) do 
    {
  ...
  while ( j++ < for_end ) ;} 
  lab40: {
      register int for_end; j = 0 ;for_end = lhyf - 1 ; if ( j <= 
  for_end) do 
    hyf [j ]= 0 ;
  while ( j++ < for_end ) ;} 
  {register int for_end; j = 0 ;for_end = rhyf - 1 ; if ( j <= for_end) 
  do 
    hyf [hn - j ]= 0 ;
  while ( j++ < for_end ) ;} 
  {register int for_end; j = lhyf ;for_end = hn - rhyf ; if ( j <= 
  for_end) do 
    if ( odd ( hyf [j ]) ) 
    goto lab41 ;
  while ( j++ < for_end ) ;} 
...
showsavegroups ( void ) 
{
  ...
  while ( true ) {
	...
	{register int for_end; i = 1 ;for_end = 3 ; if ( i <= for_end) 
	do 
...
zvsplit ( halfword n , scaled h ) 
{
  ...
  q = vertbreak ( mem [v + 5 ].hh .v.RH , h , eqtb [29902 ].cint ) ;
  p = mem [v + 5 ].hh .v.RH ;
  if ( p == q ) 
  ...
  Result = vpackage ( p , h , 0 , eqtb [29902 ].cint ) ;
  return Result ;
} 
void 
printtotals ( void ) 
...
zfreezepagespecs ( smallnumber s ) 
{
  ...
  pagecontents = s ;
  pagesofar [0 ]= eqtb [29900 ].cint ;
  pagemaxdepth = eqtb [29901 ].cint ;
  pagesofar [7 ]= 0 ;
  pagesofar [1 ]= 0 ;
  pagesofar [2 ]= 0 ;
  pagesofar [3 ]= 0 ;
...
buildpage ( void ) 
{
  ...
  do {
	...
	if ( mem [r ].hh.b1 != n ) 
	{
	  ...
	  if ( eqtb [29384 + n ].cint == 1000 ) 
	  h = mem [r + 3 ].cint ;
	  else h = xovern ( mem [r + 3 ].cint , 1000 ) * eqtb [29384 + n ]
	  .cint ;
	...
	insertpenalties = insertpenalties + mem [p + 1 ].cint ;
	  ...
	  if ( eqtb [29384 + n ].cint == 1000 ) 
	  h = mem [p + 3 ].cint ;
	  else h = xovern ( mem [p + 3 ].cint , 1000 ) * eqtb [29384 + n ]
	  .cint ;
	  if ( ( ( h <= 0 ) || ( h <= delta ) ) && ( mem [p + 3 ].cint + mem 
	  [r + 3 ].cint <= eqtb [29930 + n ].cint ) ) 
	  {
	    ...
	    if ( eqtb [29384 + n ].cint <= 0 ) 
	    w = 1073741823L ;
	    else {
		
	      w = pagesofar [0 ]- pagesofar [1 ]- pagesofar [7 ];
	      if ( eqtb [29384 + n ].cint != 1000 ) 
	      w = xovern ( w , eqtb [29384 + n ].cint ) * 1000 ;
	    } 
	    if ( w > eqtb [29930 + n ].cint - mem [r + 3 ].cint ) 
	    w = eqtb [29930 + n ].cint - mem [r + 3 ].cint ;
...
itsallover ( void ) 
{
  ...
  if ( privileged () ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29899 ].cint ;
    {
  ...
  case 2 : 
	...
	if ( ! ( tx >= himemmin ) ) {
	  ...
	  if ( ( mem [tx ].hh.b0 == 0 ) || ( mem [tx ].hh.b0 == 1 ) ) 
	  {
		...
		if ( mem [q ].hh.b0 == 7 ) 
		{
		  {register int for_end; m = 1 ;for_end = mem [q ]
...
znewgraf ( boolean indented ) 
{
  ...
  if ( indented ) 
  {
    ...
    mem [curlist .tailfield + 1 ].cint = eqtb [29896 ].cint ;
  ...
  .headfield ) ) 
  {
	...
	do {
	  ...
	  if ( ! ( q >= himemmin ) ) {
	    ...
	    if ( mem [q ].hh.b0 == 7 ) 
	    {
	      {register int for_end; m = 1 ;for_end = mem [q ].hh.b1 
	      ; if ( m <= for_end) do 
		p = mem [p ].hh .v.RH ;
	      while ( m++ < for_end ) ;} 
	      if ( p == tx ) 
...
initmath ( void ) 
{
  ...
  if ( ( curcmd == 3 ) && ( curlist .modefield > 0 ) ) 
  {
    ...
    if ( eqtb [27158 ].hh .v.RH == -268435455L ) {
      ...
      if ( ( eqtb [29913 ].cint != 0 ) && ( ( ( eqtb [29318 ].cint >= 0 ) 
      && ( curlist .pgfield + 2 > eqtb [29318 ].cint ) ) || ( curlist 
      .pgfield + 1 < - (int) eqtb [29318 ].cint ) ) ) 
      {
	l = eqtb [29899 ].cint - abs ( eqtb [29913 ].cint ) ;
	if ( eqtb [29913 ].cint > 0 ) 
	s = eqtb [29913 ].cint ;
	else s = 0 ;
      } 
    ...
    eqworddefine ( 29909 , w ) ;
    curlist .eTeXauxfield = j ;
    if ( ( eTeXmode == 1 ) ) 
    eqworddefine ( 29378 , x ) ;
    eqworddefine ( 29910 , l ) ;
    eqworddefine ( 29911 , s ) ;
...
zappdisplay ( halfword j , halfword b , scaled d ) 
{
  ...
  mem [b + 4 ].cint = s + d ;
    ...
    if ( mem [t ].hh.b0 == 10 ) 
    {
      ...
      mem [tempptr + 2 ].cint = - (int) mem [j + 2 ].cint ;
      mem [tempptr + 3 ].cint = - (int) mem [j + 3 ].cint ;
      mem [u ].hh .v.RH = t ;
    } 
    else {
...
aftermath ( void ) 
{
  ...
  {
    {
      mem [curlist .tailfield ].hh .v.RH = newmath ( eqtb [29897 ].cint , 
      0 ) ;
      curlist .tailfield = mem [curlist .tailfield ].hh .v.RH ;
    } 
    curmlist = p ;
...
znewfont ( smallnumber a ) 
{
  ...
  nameinprogress = false ;
  {register int for_end; f = 1 ;for_end = fontptr ; if ( f <= for_end) 
  do 
...
zcheckpdfoutput ( strnumber s , boolean iserror ) 
{
  ...
  if ( eqtb [29339 ].cint <= 0 ) 
  {
    if ( iserror ) 
    pdferror ( s , 1783 ) ;
    else pdfwarning ( s , 1784 , true , true ) ;
  } 
} 
void 
scanpdfexttoks ( void ) 
...
zscaleimage ( int n ) 
{
  ...
  if ( ( xr > 65535L ) || ( yr > 65535L ) ) 
  {
    xr = 0 ;
    yr = 0 ;
    pdfwarning ( 1782 , 1813 , true , true ) ;
  } 
...
scanpdfboxspec ( void ) 
{
  register int Result; scanpdfboxspec_regmem 
  Result = 0 ;
  if ( scankeyword ( 1815 ) ) 
...
scanimage ( void ) 
{
  ...
  {
    pdfwarning ( 1822 , 1823 , true , true ) ;
  ...
  {
    pdfwarning ( 1822 , 1824 , true , true ) ;
  ...
  if ( eqtb [29350 ].cint > 0 ) 
  {
    if ( warnpdfpagebox ) 
    {
      pdfwarning ( 1822 , 1825 , true , true ) ;
      warnpdfpagebox = false ;
    } 
...
{
  register int Result; outlinelistcount_regmem 
  int k  ;
  k = 1 ;
...
void 
zthreadtitle ( int thread ) 
{
  threadtitle_regmem 
  pdfprint ( 1886 ) ;
  if ( objtab [thread ].int0 < 0 ) 
  pdfprint ( - (int) objtab [thread ].int0 ) ;
...
void 
zpdffixthread ( int thread ) 
{
  pdffixthread_regmem 
  halfword a  ;
  pdfwarning ( 1830 , 1887 , false , false ) ;
  if ( objtab [thread ].int0 < 0 ) 
  {
    print ( 1200 ) ;
    print ( - (int) objtab [thread ].int0 ) ;
    print ( 125 ) ;
  } 
  else {
...
doextension ( void ) 
{
  ...
  case 17 : 
	...
	if ( scankeyword ( 1852 ) ) 
	{
      ...
      else if ( scankeyword ( 1858 ) ) 
      mem [curlist .tailfield + 5 ].hh.b0 = 7 ;
      else if ( scankeyword ( 1859 ) ) 
      mem [curlist .tailfield + 5 ].hh.b0 = 1 ;
      else pdferror ( 1782 , 1860 ) ;
      {
	getxtoken () ;
	if ( curcmd != 10 ) 
	backinput () ;
  ...
  case 46 : 
    {
      checkpdfoutput ( 1884 , true ) ;
      newwhatsit ( 46 , 2 ) ;
    } 
    break ;
  case 47 : 
    {
      checkpdfoutput ( 1885 , true ) ;
      newwhatsit ( 47 , 2 ) ;
    } 
    break ;
    default: 
  ...
  if ( fixedpdfoutput > 0 ) 
  {
	...
	if ( fixedpdfdraftmode == 0 ) 
	{
	  ...
	  while ( objtab [k ].int4 == 0 ) {
	    ...
	    pdfwarning ( 1199 , 1204 , false , false ) ;
	    printint ( objtab [k ].int0 ) ;
	    print ( 1205 ) ;
	    println () ;
	    println () ;
	  ...
	  {register int for_end; k = 1 ;for_end = fontptr ; if ( k <= 
	  for_end) do 
	    ...
	    ) ) 
	    {
	      ...
	      {register int for_end; j = 0 ;for_end = 255 ; if ( j <= 
	      for_end) do 
		...
		pdfmarkchar ( i , j ) ;
	      ...
	      pdffontattr [i ], pdffontattr [k ]) ) 
	      {
		pdfwarning ( 1206 , 1207 , false , false ) ;
	  ...
	  do {
		...
		pdfprint ( 1210 ) ;
		{
	      ...
	      pdfintentryln ( 1194 , objtab [l ].int0 ) ;
	      if ( ! isroot ) 
	      pdfindirectln ( 1168 , pdflastpages ) ;
	      pdfprint ( 1211 ) ;
	      j = 0 ;
	  ...
	  if ( pdffirstoutline != 0 ) 
	  {
	    ...
	    pdfindirectln ( 1192 , pdffirstoutline ) ;
	    pdfindirectln ( 1193 , pdflastoutline ) ;
	    pdfintentryln ( 1194 , k ) ;
	    pdfenddict () ;
	    k = headtab [4 ];
	    while ( k != 0 ) {
		...
		pdflastoutline = k ;
	      ...
	      pdfbegindict ( k , 1 ) ;
	      pdfindirectln ( 1195 , pdfmem [objtab [k ].int4 ]) ;
	      pdfindirectln ( 65 , pdfmem [objtab [k ].int4 + 6 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 1 ]!= 0 ) 
	      pdfindirectln ( 1168 , pdfmem [objtab [k ].int4 + 1 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 2 ]!= 0 ) 
	      pdfindirectln ( 1196 , pdfmem [objtab [k ].int4 + 2 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 3 ]!= 0 ) 
	      pdfindirectln ( 1197 , pdfmem [objtab [k ].int4 + 3 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 4 ]!= 0 ) 
	      pdfindirectln ( 1192 , pdfmem [objtab [k ].int4 + 4 ]) ;
	      if ( pdfmem [objtab [k ].int4 + 5 ]!= 0 ) 
	      pdfindirectln ( 1193 , pdfmem [objtab [k ].int4 + 5 ]) ;
	      if ( objtab [k ].int0 != 0 ) 
	      pdfintentryln ( 1194 , objtab [k ].int0 ) ;
	  ...
	  pdfindirectln ( 1216 , pdflastpages ) ;
	  if ( threads != 0 ) 
	  pdfindirectln ( 1217 , threads ) ;
	  if ( outlines != 0 ) 
	  pdfindirectln ( 1218 , outlines ) ;
	  if ( namestree != 0 ) 
	  pdfindirectln ( 1219 , namestree ) ;
	  ...
	  if ( pdfcatalogopenaction != 0 ) 
	  pdfindirectln ( 1220 , pdfcatalogopenaction ) ;
	  pdfenddict () ;
	  pdfprintinfo () ;
	  if ( pdfosenable ) 
	  {
	    ...
	    pdfindirectln ( 1241 , root ) ;
	    pdfindirectln ( 1242 , objptr - 1 ) ;
	    ...
	    pdfbeginstream () ;
	    {register int for_end; k = 0 ;for_end = sysobjptr ; if ( k 
	    <= for_end) do 
	      {
		if ( ! ( objtab [k ].int2 > -1 ) ) 
		{
	    ...
	    {register int for_end; k = 1 ;for_end = objptr ; if ( k <= 
	    for_end) do 
	      {
		if ( ! ( objtab [k ].int2 > -1 ) ) 
		{
	  ...
	  if ( ! pdfosenable ) 
	  {
	    ...
	    pdfprint ( 1244 ) ;
	    pdfintentryln ( 1238 , sysobjptr + 1 ) ;
	    pdfindirectln ( 1241 , root ) ;
	    pdfindirectln ( 1242 , sysobjptr ) ;
	    if ( pdftrailertoks != -268435455L ) 
	    {
	      pdfprinttoksln ( pdftrailertoks ) ;
	      {
	...
	if ( fixedpdfdraftmode == 0 ) 
	bclose ( pdffile ) ;
	else pdfwarning ( 0 , 1198 , true , true ) ;
      } 
      if ( logopened ) 
      {
	putc ('\n',  logfile );
...
debughelp ( void ) 
{
  ...
  while ( true ) {
	...
	break ;
      case 14 : 
	{register int for_end; k = 0 ;for_end = n ; if ( k <= for_end) 
	do 
	  print ( buffer [k ]) ;
	while ( k++ < for_end ) ;} 
	break ;
...
scanfilenamebraced ( void ) 
{
  ...
  stopatspace = false ;
  beginname () ;
  {register int for_end; i = strstart [s ];for_end = strstart [s + 1 
  ]- 1 ; if ( i <= for_end) do 
