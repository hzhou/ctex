...
static void write_png_palette(int img)
{
    int i, j, k, l;
...
static void write_png_gray(int img)
{
    int i, j, k, l;
    png_bytep row, r, *rows;
    if (img_colorspace_ref(img) != 0) {
...
static void write_png_gray_alpha(int img)
{
    int i, j, k, l;
    png_bytep row, r, *rows;
    int smask_objnum = 0;
...
static void write_png_rgb(int img)
{
    int i, j, k, l;
    png_bytep row, r, *rows;
    if (img_colorspace_ref(img) != 0) {
...
static void write_png_rgb_alpha(int img)
{
    int i, j, k, l;
    png_bytep row, r, *rows;
    int smask_objnum = 0;
...
static bool last_png_needs_page_group;
static bool transparent_page_group_was_written = false;
